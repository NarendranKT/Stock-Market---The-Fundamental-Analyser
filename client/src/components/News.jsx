    ...
    return (
        <div className="bg-primary mt-10 flex flex-col flex-wrap">
            <motion.div variants={textVariant()}> 
                <p className={`${styles.sectionSubText}`}>Headlines | market and business news | Global</p>
                <h1 className={`${styles.sectionHeadText}`}>News Today</h1>
            </motion.div>
